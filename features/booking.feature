Feature: Registered users should be able to book a court
  ...
  Scenario: making more than three bookings during peak periods
    Given I login as "joebloggs" with password "password"
    And there is a booking with user id: 999 and court number: 1 and booking date and time: "02 September 2013 19:00"
    And there is a booking with user id: 999 and court number: 2 and booking date and time: "03 September 2013 17:40"
    And there is a booking with user id: 999 and court number: 3 and booking date and time: "04 September 2013 19:40"
    When I go to the new booking page
  ...
  Scenario: deleting a booking for the current user
    Given I login as "joebloggs" with password "password"
    When I view the booking with user id: 999 and court number: 1 and booking date and time: "02 September 2013 19:00"
