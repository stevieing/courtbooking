...
module Courtbooking
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/lib/utils #{config.root}/lib/validators #{config.root}/lib/mixins #{config.root}/lib/setup)
    ...
    config.action_mailer.asset_host = Proc.new { |source, request|
      (request ? request.protocol : 'http://') + Rails.configuration.mailer['smtp']['domain']
    }
