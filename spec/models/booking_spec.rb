...
describe Booking do
  ...
  context "time in the past" do
    ...
    subject {build(:booking, court_number: 1, playing_on: "16 September 2013", time_from: "18:20")}
  ...
  describe "duplicate bookings" do
    ...
    let!(:booking) { create(:booking, court_number: 1, playing_on: "17 Sep 2013", time_from: "19:00") }

    it { expect(build(:booking, court_number: 1, playing_on: "17 Sep 2013", time_from: "19:00")).to_not be_valid }
    it { expect(build(:booking, court_number: 1, playing_on: "18 Sep 2013", time_from: "19:00")).to be_valid}
    it { expect(build(:booking, court_number: 2, playing_on: "17 Sep 2013", time_from: "19:00")).to be_valid}
   ...
   describe "scope" do
     ...
     let!(:booking1) {create(:booking, court_number: 1, playing_on: "17 Sep 2013", time_from: "19:00") }
     let!(:booking2) {create(:booking, court_number: 2, playing_on: "17 Sep 2013", time_from: "12:00") }
     let!(:booking3) {create(:booking, court_number: 2, playing_on: "18 Sep 2013", time_from: "20:40") }
     let!(:booking4) {create(:booking, court_number: 3, playing_on: "17 Sep 2013", time_from: "10:00") }
