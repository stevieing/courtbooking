...
* SQLite
* Postgres (unless removed from the gemfile)
* Redis
...
It is strongly recommended that you change the username and password for this user. The email address will also need to be changed. This user has full access rights.
...
In development and staging I have used my own providers SMTP server and in production I have used Exim4.
